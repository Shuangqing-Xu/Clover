...
def load_fashionmnist_data(datadir):
    ...
    train_ds = FashionMNIST_truncated(datadir, train=True, download=True, transform=train_transform)
    test_ds = FashionMNIST_truncated(datadir, train=False, download=True, transform=test_transform)
...
def get_dataloader_fashionmnist(datadir, train_bs, test_bs, dataidxs=None, test_idxs=None, 
    ...
    train_ds = FashionMNIST_truncated(datadir, dataidxs=dataidxs, train=True,
                                    transform=transform_train, download=True,
                                    cache_data_set=cache_train_data_set)
    test_ds = FashionMNIST_truncated(datadir, dataidxs=test_idxs, train=False,
                                   transform=transform_test, download=True,
                                   cache_data_set=cache_test_data_set)
    
    train_dl = data.DataLoader(train_ds, batch_size=train_bs, shuffle=True)
    test_dl = data.DataLoader(test_ds, batch_size=test_bs, shuffle=True)
    return train_dl, test_dl

def load_partition_data_fmnist(data_dir, partition_method, partition_alpha,
    ...
    transform_train, _ = _data_transforms_fashionmnist()
    cache_train_data_set = FashionMNIST(data_dir, train=True, transform=transform_train, download=True)
    cache_test_data_set = FashionMNIST(data_dir, train=False, transform=transform_train, download=True)
    ...
    for client_idx in range(client_number):
        ...
        train_data_local, test_data_local = get_dataloader_fashionmnist( data_dir, batch_size, batch_size,
